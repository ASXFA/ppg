...
<div class="row">
     <div class="col-lg-12">
        <div class="intro-text">
            ...
            <span class="boxtext"><i class="fa fa-sign-in"></i> Halaman Login <b>Pedagang</b></span>
            ...
            <h4 class="text-success"><br><br>
               ...
               Login Administrasi pedagang
            </h4>
            <div class="col-md-12">
                <span class="text-success">Masukkan NIK dan No Pendaptaran yang diperoleh saat melakukan pendaftaran secara online.</span><br>
            </div>
             ...
             <span class="text-success"></span>
                <form action="" method="post">
                    <div class="form-group" style="padding-left:15px;padding-right:15px">
                        <input type="text" name="username" class="inp" placeholder="NIK" required="true"  autofocus/>
                    </div>
                    <div class="form-group has-feedback" style="margin-top:-20px;padding-left:15px;padding-right:15px">
                        <input type="password" name="password" class="inp" placeholder="No. Pendaftaran" required="true" />
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
