            ...
            <div style="margin-top:-8px;">
              <h2>
                <strong class="text-primary">
                  <a href=""><img src="img/logo.png" alt="Logo" width="30" style="position:absolute;margin-top:-8px;"> <span style="margin-left:35px;color:#fff;">PPG ONLINE</span></a>
                </strong>
                </h>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran<strong> PPG ONLINE</strong></h2>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="style">
                    ...
                    <div class="wizard-div current wizard-sea" id="register">
                      <form role="form" class="wizard wizard-validation" data-style="sea" action="" enctype="multipart/form-data" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 panel p-20" style="text-align:center">
                                ...
                                <span style="font-size:15px">
                                  Proses PPG ONLINE hampir selesai. Silakan periksa kembali data-data yang sudah anda masukkan.
                                  <br><br>
                                  <div class="col-md-12">
                                    <span class="text-primary" style="font-size:18px;"><strong>Apakah data sudah sesuai dan lengkap?</strong></span>
                                    <div class="form-group">
            ...
            <div class="footer">
              <div class="copyright">
                <p class="pull-left sm-pull-reset">
                  <span>Copyright &copy; <a href="#" target="_blank">Hamba Allah</a> <?php echo date('Y'); ?></span>
                </p>
                <p class="pull-right sm-pull-reset">
                  <span><a href="" class="m-r-10"><i class="fa fa-home"></i> Beranda </a> | <a href="#" class="m-l-10 m-r-10" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-legal"></i>Ketentuan & Syarat PPG</a></span>
                </p>
              </div>
            </div>
          </div>
